...
dst_dir_path = r"J:\BaiduNetdiskDownload\足球备份"
...
replace_string_list = ['【天下足球网www.txzqw.cc】', '【天下足球网www.txzqw.me】',
                       ...
                       '2018-19赛季', '2018-19', '18-19赛季',
                       '19-20赛季', '2019-20赛季',
                       '2020-21赛季', '2021年',
                       '2021-22赛季', '21-22赛季',
                       '高清国语', 'hdtv', '720P50',
                       '720P30', '720P',
                       '1080P50', '1080P30', '1080P',
                       '1080i', '1080',
...
commentator = ['詹俊', '刘越', '娄一晨', '李彦', '刘腾', '贺宇', '申方剑', '孟洪涛', '林梦鸽', '陈渤胄',
               ...
               '吴桐', '刘焕', '盛斌', '刘晶捷', '李子琪', '颜强', '曹菁芮', '金相凯', '刘勇', '魏翊东',
               '克韩', '邵煊', '石庆圣', '张路', '管振鸿', '谭逸雄', '管振鸿', '杨璞', '孙雨轩', '徐阳',
               '蔡惠强', '李金羽', '王寅初', '刘嘉成', '魏欣怡', '王宇', '邵佳一', '陈侃', '蔡慧强',
               '李家成', '朱晓雨', '刘嘉远', '熊冰杰', '贺炜', '宫磊', '李晨明', '邵圣懿', '董午志',
               '牛银昊', '曾侃', '孙思辰', '洪刚', '黄健翔', '陈熙荣', '王晓龙', '贾天宇', '苗锟']
